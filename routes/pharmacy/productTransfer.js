...
router.post("/pharmacy/transfer", requirePermissions(systemPermission),
...
router.delete('/pharmacy/transfer/:transferId', requirePermissions(systemPermission), async (req, res) => {
...
router.get("/pharmacy/transfers", requirePermissions(systemPermission), async (req, res) => {
    try {
